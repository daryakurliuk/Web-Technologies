...
$("#filter").click(function () {
    var firstLetter = document.getElementById('Filter');
...
$("#cFilter").click(function () {
    var firstLetter1 = document.getElementById('Filter1');
    var firstLetter2 = document.getElementById('Filter2');
    var firstLetter3 = document.getElementById('Filter3');
